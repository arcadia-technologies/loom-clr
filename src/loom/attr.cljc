...
thickness, etc)."
  ...
  flybot.ports.loom.attr
  (:require [flybot.ports.loom.graph :refer [directed? nodes edges src dest has-node?]
             :as graph]
            #?@(:default [[flybot.ports.loom.cljs :refer (def-protocol-impls)]]
                :cljs []))
...
(extend flybot.ports.loom.graph.BasicEditableGraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.BasicEditableDigraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.BasicEditableWeightedGraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.BasicEditableWeightedDigraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.FlyGraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.FlyDigraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.WeightedFlyGraph
  AttrGraph
  default-attr-graph-impl)

(extend flybot.ports.loom.graph.WeightedFlyDigraph
  AttrGraph
  default-attr-graph-impl)
